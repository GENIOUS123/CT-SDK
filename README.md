...
1. Client completes verification with Carbontrace  
2. Carbontrace issues a **client access token**  
3. SDK is embedded into the client website/app  
4. End-users connect their wallet  
5. Rewards are distributed and displayed automatically  
